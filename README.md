# sqlparser [![Build Status](https://img.shields.io/travis/yext/sqlparser.svg)](https://travis-ci.org/yext/sqlparser) [![Coverage](https://img.shields.io/coveralls/yext/sqlparser.svg)](https://coveralls.io/github/yext/sqlparser) [![Report card](https://goreportcard.com/badge/github.com/yext/sqlparser)](https://goreportcard.com/report/github.com/yext/sqlparser) [![GoDoc](https://godoc.org/github.com/yext/sqlparser?status.svg)](https://godoc.org/github.com/yext/sqlparser)
...
XWB1989=${GOPATH?}/src/github.com/yext/sqlparser/
...
# Fix imports
sed -i '.bak' 's_vitess.io/vitess/go/vt/proto/query_github.com/yext/sqlparser/dependency/querypb_g' *.go dependency/sqltypes/*.go
sed -i '.bak' 's_vitess.io/vitess/go/_github.com/yext/sqlparser/dependency/_g' *.go dependency/sqltypes/*.go
