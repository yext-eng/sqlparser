...
func TestCreateTable(t *testing.T) {
	...
	validBooleanColumnDDL := []string{
		...
		"create table tbl_kw_ident (action varchar(100) not null, status varchar(100) not null)",
		...
		"create table tbl_fk_action (id bigint not null, parent_id bigint, foreign key (parent_id) references parent_tbl (id) on delete no action on update cascade)",
